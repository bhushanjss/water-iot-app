...
function SelectCascadeFormItem(props) {
  const {
    label,
    name,
    hint,
...
SelectCascadeFormItem.defaultProps = {
  required: false,
  isClearable: true,
};

SelectCascadeFormItem.propTypes = {
  ...
  callAfter: PropTypes.func,
};

export default SelectCascadeFormItem;
