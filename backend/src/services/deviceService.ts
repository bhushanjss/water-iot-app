...
export default class DeviceService {
  ...
  async create(data) {
    ...
    try {
      ...
      const record = await DeviceRepository.create(data, {
        ...this.options,
        session,
      });
  ...
  async update(id, data) {
    ...
    try {
      ...
      const record = await DeviceRepository.update(
        id,
        data,
        {
          ...this.options,
  ...
  async destroyAll(ids) {
    ...
    try {
      for (const id of ids) {
        await DeviceRepository.destroy(id, {
          ...this.options,
          session,
        });
      }
  ...
  async findAndCountAll(args) {
    return DeviceRepository.findAndCountAll(
      args,
      this.options,
    );
  }
