...
function WaterReadingToolbar(props) {
  const [
  ...
  const hasPermissionToCreate = useSelector(
    waterReadingSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    waterReadingSelectors.selectPermissionToImport,
  );
  ...
  return (
    <ToolbarWrapper>
      ...
      {hasPermissionToAuditLogs && (
        <Button
          component={Link}
          to="/audit-logs?entityNames=waterReading"
...
export default WaterReadingToolbar;
